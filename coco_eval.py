...
def evaluate_coco(img_path, set_name, image_ids, coco, model, threshold=0.05):
    ...
    for image_id in tqdm(image_ids):
        ...
        x = paddle.to_tensor(framed_imgs[0], dtype=paddle.float32)

        x = x.unsqueeze(0).transpose([0, 3, 1, 2])
...
if __name__ == '__main__':
    ...
    VAL_GT = f'/home/aistudio/{params["project_name"]}/annotations/instances_{SET_NAME}.json'
    VAL_IMGS = f'/home/aistudio/{params["project_name"]}/{SET_NAME}/'
    MAX_IMAGES = 10000
    coco_gt = COCO(VAL_GT)
