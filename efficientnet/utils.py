...
def load_pretrained_weights(model, model_name, load_fc=True, advprop=False):
    ...
    local_weight_path = get_weights_path_from_url(url_map_[model_name])
    state_dict = paddle.load(local_weight_path)
    # state_dict = paddle.load('../../weights/backbone_efficientnetb0.pdparams')
    if load_fc:
